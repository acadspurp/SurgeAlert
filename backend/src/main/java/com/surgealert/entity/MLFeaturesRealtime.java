...
public class MLFeaturesRealtime {
    ...
    @Column(name = "QC_Lag1_mm", nullable = true)
    private Double qcLag1Mm;

    @Column(name = "QC_Lag2_mm", nullable = true)
    ...
    @Column(name = "Mar_Lag1_mm", nullable = true)
    private Double marLag1Mm;

    @Column(name = "Mar_Lag2_mm", nullable = true)
    ...
    private Integer predictedAlertClass; // 0, 1, 2, 3
