    ...
    return (
        <div id="home-view" className="min-h-screen bg-[#0f172a] text-gray-200 px-1 sm:px-0 lg:p-6 pb-28 sm:pb-24 max-w-[100vw] overflow-x-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-6">
                ...
                {/* RIVER LEVEL GAUGE — tap on mobile to jump to Safety Action Guide */}
                <div
                    className={`lg:col-span-5 xl:col-span-6 rounded-2xl p-4 sm:p-6 border ${colors.border} ${colors.bg} ${colors.glow} flex flex-col justify-between overflow-hidden max-md:cursor-pointer max-md:active:opacity-95 max-md:transition-opacity`}
                    onClick={scrollToSafetyGuide}
                    role="region"
                    aria-label="River level gauge. On a small screen, tap this card to scroll to the Safety Action Guide."
                >
                    <div className="mb-4 flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
                        <h2 className="text-sm font-bold uppercase tracking-widest text-gray-400">River Level Gauge</h2>
                        <p className="text-[10px] font-semibold text-cyan-400/90 md:hidden">Tap card → Safety Action Guide</p>
                    </div>
            ...
            <div
                id="safety-action-guide"
                className={`scroll-mt-24 rounded-2xl p-4 sm:p-6 mb-6 border-2 bg-gradient-to-br from-[#1e293b] to-[#0f172a] ${colors.border} ${colors.glow} min-w-0`}
            >
