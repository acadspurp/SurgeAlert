const fs = require('fs');
let content = fs.readFileSync('src/pages/Admin/index.jsx', 'utf8');

const handlersStart = content.indexOf('    // -------------------------------------------------------------\n    // HANDLERS');
const userManageStart = content.indexOf('    // User Management Modal Handlers');

if (handlersStart === -1 || userManageStart === -1) {
...
const newContent = content.substring(0, handlersStart) + correctHandlers + content.substring(userManageStart);
fs.writeFileSync('src/pages/Admin/index.jsx', newContent);
