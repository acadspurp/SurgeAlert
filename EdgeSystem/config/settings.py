...
# --- SECURITY & NETWORK ---
# Make sure this IP matches your computer's IP (ipconfig/ifconfig)
...
# Ultrasonic Trig -> Physical Pin 16 -> GPIO 23
TRIG_PIN = 23  

# Ultrasonic Echo -> Physical Pin 18 -> GPIO 24
ECHO_PIN = 24  

# Radar (RCWL-0516) OUT -> Physical Pin 22 -> GPIO 25
RADAR_PIN = 25 
...
if ENVIRONMENT_MODE == "AQUARIUM":
    ...
    # Simulator Ranges (Ignored when USE_HARDWARE is True)
